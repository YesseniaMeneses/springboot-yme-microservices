...
import com.yme.movementsservice.infraestructure.output.adapter.repository.MovementRepository;
...
public class ReportServiceImpl implements ReportService {
    ...
    public List<MovementsByAccount> getMovementsByAccount(String dateRange, Long clientId) {
        ...
        if (!accountNumbers.isEmpty()){
            Date startDate = com.yme.movementsservice.infraestructure.util.validation.Date.stringToDate(filter.getStartDate());
            Date endDate = com.yme.movementsservice.infraestructure.util.validation.Date.stringToDate(filter.getEndDate());
    ...
    private MovementDetail mapToMovementDetail(Movement movement) {
        String date = com.yme.movementsservice.infraestructure.util.validation.Date.dateToString(movement.getDate());
    ...
    private Filter mapToFilter(String dateRange, Long clientId) {
        String[] range = com.yme.movementsservice.infraestructure.util.validation.Date.validateRangeDate(dateRange);
